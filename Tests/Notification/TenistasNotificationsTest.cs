...
{
    [Test]
    [DisplayName("Enviar notificación se hace cuando el flujo no está lleno")]
    public async Task EnviarNotificacion_CuandoElFlujoNoEstaLleno()
    {
        // Arrange
    ...
    public async Task EnviarNotificacion_DescartaViejaYRecibeNueva()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.Message, Is.EqualTo(notification2.Message),
                "El mensaje de la notificación debe ser igual.");
